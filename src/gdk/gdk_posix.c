...
int setMonetDB5LibraryPath(const char* path) {
	...
	return monetdb_lib_path != NULL ? 1 : 0;
}

#ifdef NATIVE_WIN32
/* on Windows compilation of MonetDBJavaLite, this function was still missing */
/* adapted from https://llvm.org/svn/llvm-project/compiler-rt/branches/release_30/lib/popcountdi2.c */
